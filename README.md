...
**Key mathematical structure (Weyl projection):**
\[
...
**Effective mass generated by geometric inertia:**
\[
m_{\rm eff} = \frac{2}{1-\kappa}
\]
...
The present framework is intentionally minimal and still incomplete:

- The continuum limit currently describes an **open / active system** (exponential density growth).
- Recovering a fully conservative, unitary Dirac operator remains an open problem.
- An explicit microscopic mapping that derives the geometric inertia parameter \(\kappa\) from first principles has not yet been established.

These limitations are stated deliberately. Overclaiming is the fastest way to be ignored in theoretical physics. The model is offered as a coherent geometric candidate, not as a finished theory.
