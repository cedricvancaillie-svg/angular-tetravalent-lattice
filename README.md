...
**Core continuum projection (Weyl-like dynamics):**
...
The present framework is still incomplete in several important respects:

- The continuum limit currently describes an **open / active system** (the total density grows exponentially).
- Recovering a fully **conservative, unitary Dirac operator** from the discrete angular lattice remains an open problem.
- An explicit microscopic derivation of the geometric inertia parameter \(\kappa\) from first principles has not yet been achieved.

These limitations define the natural next steps of the research programme.
